  ...
  return (
    <>
      ...
      <main>
        ...
        {/* CTA BANNER */}
        <section className="cta-banner cta-banner--accent">
        ...
        <section className="cta-banner cta-banner--secondary">
          <h2 className="section-title">04 / Planning Toolkit</h2>
          <div className="cta-banner__content">
            <h3 className="cta-banner__title">
              Expert guidance to help you plan your trip
            </h3>
            <p className="cta-banner__description">
              Sign up to our mailing list to get our expert travel guides
